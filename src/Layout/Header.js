...
import Logos from "../resources/thalassa_holdings.png";
  ...
  return (
    <>
      ...
      <div className={styles.headerTop}>
        <div class={styles.headerTopleft}>
          <span>OFFSHORE OIL AND GAS OPERATIONS</span>
        </div>

        <div class={styles.headerTopright}>
          <span>
            <i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;{" "}
            <a href="mailto:talassak@yahoo.com"> thalassa@yahoo.com</a>
          </span>
          <span>
            <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;{" "}
            <a href="tel:306988871171">+30 6988871171 </a>
          </span>
    ...
    <span className={styles.logoCaptionText2}>HEALTH CARE SERVICE INC.</span>
        ...
        <div className={styles.headermiddle}>
          ...
          <Square
            fa={<i class="fa fa-wrench" style={{ fontSize: 20 }}></i>}
            title={"Our Services"}
          />
          <Square
            fa={<i class="fa fa-map-marker" style={{ fontSize: 20 }}></i>}
            title={"Our Location"}
          />

          <Square
            fa={<i class="fa fa-building" style={{ fontSize: 20 }}></i>}
            title={"Fleets and Facilities"}
          />
          <Square
            fa={<i class="fa fa-phone" style={{ fontSize: 20 }}></i>}
            title={"Contacts"}
          />
        ...
        <div className={styles.menuicon}>
          ...
          <div className={styles.dropdownmenu} style={{ display: display }}>
            <div className={styles.dropdown}>
              ...
              <span>
                <i class="fa fa-wrench" aria-hidden="true"></i>&nbsp;Our
                Services
              </span>
              <span>
                <i class="fa fa-map-marker" style={{ fontSize: 20 }}></i>
                &nbsp;Our Location
              </span>
              <span>
                <i class="fa fa-building" style={{ fontSize: 20 }}></i>
                &nbsp;Fleets and Facilities
              </span>
              <span>
                <i class="fa fa-phone" style={{ fontSize: 20 }}></i>
                &nbsp;Contacts
              </span>
            </div>
          </div>
